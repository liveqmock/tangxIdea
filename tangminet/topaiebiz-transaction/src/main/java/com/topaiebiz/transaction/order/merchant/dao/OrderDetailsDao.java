 ...
 */
@Mapper
public interface OrderDetailsDao extends BaseDao<OrderDetailEntity> {
	...
	* @param:
	**/
	List<OrderDetailEntity> selectOrderDetailByOrderId(Long orderId);
	 ...
	 * @return
	 */
	List<OrderDetailEntity> selectlistByOrderId(Long orderId);
	 ...
	 * @return
	 */
	List<OrderDetailEntity> findOneByPromotionAndSkuId(@Param(value="usedPromotionId")Long usedPromotionId, @Param(value="goodsId")Long goodsId);
	...
	* @param:
	**/
	List<OrderDetailEntity> getOrderDetailListBySkidsAndOrderId(@Param("skuIds") List<Long> skuIds, @Param("storeOrderId") Long storeOrderId);
	...
	* @param:
	**/
	List<OrderDetailEntity> getOrderDetailByIds(@Param("orderDetailIds") List<Long> orderDetailIds);
	...
	* @param:
	**/
	OrderDetailEntity findByOrderIdAndGoodsId(@Param("orderId") Long orderId, @Param("goodsId") Long goodsId);
