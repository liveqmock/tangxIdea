 ...
 */
@Mapper
public interface TotalOrderDao extends BaseDao<OrderPayEntity> {
	 ...
	 * @return
	 */
	List<OrderPayEntity> getTotalOrderByParams(TotalOrderParamDto totalOrderParamDto);
	 ...
	 * @return
	 */
	List<OrderPayEntity> getBeforDaysDataComparison(@Param(value = "beforDate") Date beforDate,
