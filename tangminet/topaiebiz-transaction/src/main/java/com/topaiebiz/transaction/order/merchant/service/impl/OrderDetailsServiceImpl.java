...
//
//		OrderEntity storeOrderEntity=storeOrderDao.selectById(id);
...
//		/**根据订单编号查询商品信息*/
//		List<OrderDetailEntity> selectByOrderId= orderDetailsDao.selectOrderDetailByOrderId(id);
//		/**订单的总优惠金额*/
//		Double sumDeduction=0.0;
//		/**订单总运费*/
//		Double totalFreight=0.0;
//		for(OrderDetailEntity orderDetailsEntity:selectByOrderId) {
//			/**此商品的优惠金额*/
