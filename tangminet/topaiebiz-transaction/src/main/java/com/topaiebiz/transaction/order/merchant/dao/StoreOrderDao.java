 ...
 */
@Mapper
public interface StoreOrderDao extends BaseDao<OrderEntity> {
	...
	**/
	 ...
	 * @return
	 */
	List<OrderEntity> selectByTotalOrderId(Long totalOrderId);
	 ...
	 * @return
	 */
	List<OrderDetailEntity> selectList(Long orderId);
	 ...
	 * @return
	 */
	List<OrderEntity> selectReceivedOrder();
	 ...
	 * @param:
	 **/
	List<OrderEntity> getTodayOrderList();
	...
	* @param:
	**/
	List<OrderDetailEntity> selectByOrderId(Long orderId);
