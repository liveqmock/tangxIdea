...
public interface MerchantInfoDao extends BaseMapper<MerchantInfoEntity> {
	 ...
	 * @param dto
	 */
	List<StoreInfoDto> selectStoreInfoByName(MerchantInfoDto dto);
	 ...
	 * return : 返回成功结果参数
	 */
	Integer updateMerchantInfoByMerchantGradeId(MerchantInfoGradeDto merchantInfoGradeDto);
	 ...
	 * @return
	 */
	List<MerchantInfoDto> selectMerchantInfoByName(MerchantInfoDto merchantInfoDto);
	 ...
	 * @return
	 */
	List<StoreInfoDto> selectStoreInfoList(StoreInfoDto storeInfoDto);
