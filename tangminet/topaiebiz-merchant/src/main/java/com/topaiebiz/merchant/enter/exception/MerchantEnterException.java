...
public enum MerchantEnterException implements ExceptionInfo {
	...
	FREIGHTNAME_NOT_NOLL("30000019","The merchant id cannot be empty!!!"),
	...
	FREIGHTNAME_ID_NOT_NOLL("30000027","The template id cannot be empty!"),

	FREIGHTNAME_ID_NOT_EXIST("30000028","The template id cannot be exist!"),

	FREIGHTTEMPLATEDETAIL_ID_NOT_NULL("30000029","The templatedetail id cannot be empty!"),

	MEMBERINFO_MOBILPHONE_NULL("30000030","The memberinfo id cannot be enpty!"),

	THE_TEMPLATE_IS_IN_USE("30000033","The template is in use!"),
	THE_PRICING_CANNOT_BE_MODIFIED("30000034","The template pricing cannot be modified");
