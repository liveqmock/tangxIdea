//package com.topaiebiz.sms.third.dahantc.service.impl;
//
//import com.dahantc.api.sms.json.JSONHttpClient;
//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.nebulapaas.common.redis.cache.RedisCache;
//import com.nebulapaas.web.exception.GlobalException;
//import com.topaiebiz.sms.third.dahantc.dto.MessageDto;
//import com.topaiebiz.sms.third.dahantc.entity.CaptchaEntity;
//import com.topaiebiz.sms.exception.MessageExceptionEnum;
//import com.topaiebiz.sms.third.dahantc.service.MessageService;
//import com.topaiebiz.sms.third.dahantc.util.DateUtil;
...
//        // captcha存入redis中
//        if (IS_SMSCODE_LIMIT) {
//            redisCache.set(telephone, captcha, SMSCODE_EXPIRE_TIME);
...
//        if (StringUtils.isNotBlank(redisCache.get(telephone + "_LIMIT_TIME"))) {
//            logger.error("phone={}, 发送过于频繁 请稍后再试!", telephone, SMSCODE_SEND_TIMES_ONEDAY);
//            throw new GlobalException(MessageExceptionEnum.INTERVAL_TOO_SHORT);
//        }
//        Integer s = null;
//        String TODAY_LIMIT_TIMES = redisCache.get(DateUtil.nowDateToString() + telephone + "_TODAY_LIMIT_TIMES");
...
//
//        // 待校验数据存入redis中
//        redisCache.set(telephone + "_LIMIT_TIME", new Date().getTime(), SMSCODE_LIMIT_TIME);
//        redisCache.incr(DateUtil.nowDateToString() + telephone + "_TODAY_LIMIT_TIMES");
//        redisCache.expire(DateUtil.nowDateToString() + telephone + "_TODAY_LIMIT_TIMES", (int) (86400 - DateUtils.getFragmentInSeconds(Calendar.getInstance(), Calendar.DATE)));
//
//    }
//
//    /**
...
//        }
//        Integer s = null;
//        String FAIL_OVER_TIMES = redisCache.get(DateUtil.nowDateToString() + telephone);
...
//            throw new GlobalException(MessageExceptionEnum.IPHONE_LIMIT_FAIL);
//        }
//
//        String smsCode = redisCache.get(telephone.trim());
//        if (captcha.equals(smsCode)) {
//            redisCache.delete(telephone);
//            return true;
//        } else {
//            redisCache.incr(DateUtil.nowDateToString() + telephone);
//            redisCache.expire(DateUtil.nowDateToString() + telephone, (int) (86400 - DateUtils.getFragmentInSeconds(Calendar.getInstance(), Calendar.DATE)));
//            return false;
//        }
//    }
//
