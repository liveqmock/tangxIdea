...
public class WeChatPayHelper {
     ...
     * @throws Exception
     */
    public static String httpRequest(String reportUrl, String data, boolean useCert) throws Exception{
        BasicHttpClientConnectionManager connManager;
        if(useCert){
            char[] password = WeChatConfig.MCH_ID.toCharArray();
            // 证书
            // buf 证书字节流
            InputStream certStream =  new ByteArrayInputStream(WeChatConfig.CERT_BYTE);
        ...
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(DEFAULT_READ_TIMEOUT_MS).setConnectTimeout(DEFAULT_CONNECT_TIMEOUT_MS).build();
    ...
    * @param: 
    **/
    public static String replynNotice(Boolean result) throws Exception {
