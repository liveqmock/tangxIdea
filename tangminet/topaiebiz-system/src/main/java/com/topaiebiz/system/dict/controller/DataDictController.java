...
public class DataDictController {
	...
	public ResponseInfo addDataDictType(@Valid DataDictDto dto, BindingResult result) throws GlobalException {
		...
		return new ResponseInfo(dataDictService.saveDataDict(dto));
	}
	...
	@ResponseBody
	public ResponseInfo getDataDictList(PagePO pagePO, DataDictDto dataDictDto) throws GlobalException {
		return new ResponseInfo(dataDictService.getDataDictList(pagePO, dataDictDto));
	}
