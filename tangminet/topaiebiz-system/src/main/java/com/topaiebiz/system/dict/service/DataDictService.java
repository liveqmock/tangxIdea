...
public interface DataDictService {
	 ...
	 * 
	 */
	List<DataDictTypeDto> getDataDictTypeById();
	 ...
	 *             全局统一异常类
	 */
	Integer saveDataDict(DataDictDto dto) throws GlobalException;
	 ...
	 * @return 指定的数据字典信息表数据
	 */
	DataDictDto getDataDictById(Long id);
	 ...
	 */
	PageInfo<DataDictDto> getDataDictList(PagePO pagePO, DataDictDto dataDictDto) throws GlobalException;
