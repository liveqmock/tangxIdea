...
public class DataDictTypeController {
	...
	public ResponseInfo addDataDictType(@Valid DataDictTypeDto dto, BindingResult result) throws GlobalException {
		...
		return new ResponseInfo(dataDictTypeService.saveDataDictType(dto));
	}
	...
	@ResponseBody
	public ResponseInfo getDataDictTypeList(PagePO pagePO, DataDictTypeDto dataDictTypeDto)
			throws GlobalException {
		return new ResponseInfo(dataDictTypeService.getDataDictTypeList(pagePO, dataDictTypeDto));
	}
