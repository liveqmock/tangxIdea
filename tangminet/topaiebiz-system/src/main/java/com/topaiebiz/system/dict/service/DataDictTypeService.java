...
public interface DataDictTypeService {
	 ...
	 * return 返回执行成功与否结果参数
	 */
	Integer saveDataDictType(DataDictTypeDto dto) throws GlobalException;
	 ...
	 * return 数据字典类型信息
	 */
	DataDictTypeDto getDataDictTypeById(Long id) throws GlobalException;
	 ...
	 * 
	 * @param page
	 * @param dataDictTypeDto
	 * @return
	 */
	PageInfo<DataDictTypeDto> getDataDictTypeList(PagePO pagePO, DataDictTypeDto dataDictTypeDto);
