...
public class DistrictTypeServiceImpl implements DistrictTypeService {
	...
	@Override
	public List<DistrictTypeDto> getAllDistrictTypeData() {
		List<DistrictTypeEntity> districtTypeEntities = districtTypeDao.selectDistrictType();
		List<DistrictTypeDto> districtTypeDtos = PageUtil.copyList(districtTypeEntities,DistrictTypeDto.class);
		return districtTypeDtos;
	}
	...
	public Integer createDistrictType(DistrictTypeDto districtTypeDto) throws GlobalException {
		...
		districtTypeEntity.setCreatorId(SecurityContextUtils.getCurrentUserDto().getId());
	...
	public Integer modifyDistrictType(DistrictTypeDto districtTypeDto) throws GlobalException {
		...
		BeanUtils.copyProperties(districtTypeDto, districtTypeEntity);
		districtTypeEntity.setLastModifierId(SecurityContextUtils.getCurrentUserDto().getId());
